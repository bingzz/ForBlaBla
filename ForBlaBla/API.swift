...
public final class RepositorsQuery: GraphQLQuery {
  ...
  public let operationName = "Repositors"

  public var queryDocument: String { return operationDefinition.appending(IssueDetails.fragmentDefinition) }
...
public struct IssueDetails: GraphQLFragment {
  ...
  public init(id: GraphQLID, author: Author? = nil, title: String) {
    self.init(unsafeResultMap: ["__typename": "Issue", "id": id, "author": author.flatMap { (value: Author) -> ResultMap in value.resultMap }, "title": title])
  }
